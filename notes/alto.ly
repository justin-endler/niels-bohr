...
altoNotes = \relative c {
  ...
  R1.*11 |
  R1.*4 |
  \grace b16_"try to sound like gesse"\ff b'8 r4 \grace b,16_"OR" b'8 r4 \grace b,16\ppp b'8 r4 \grace b,16\< b'8 r4 | %84
  ...
  \repeat volta 4 { g2.\f_"4x" ~ g4. f | %88
  d2. ~ d8 e4 ~ e f8 ~ | %89
  f4. d4. ~ d4 a8 ~ a4. | %90
